...
const relatorios: Relatorio[] = [
  ...
  {
    id: 'rebanho-atual',
    titulo: 'Relatório de Rebanho Atual',
    descricao: 'Visão geral do estoque vivo atual, incluindo quantidade de animais, peso médio e peso total.',
    icon: '🐄',
    href: '/dashboard/relatorios/rebanho-atual',
    categoria: 'Rebanho',
    status: 'disponivel',
  },
  {
    ...
    descricao: 'Análise comparativa de desempenho entre lotes, incluindo GMD, ganho de peso e dias no sistema.',
    icon: '📊',
  ...
  {
    id: 'pesagens-desempenho',
    titulo: 'Pesagens e Desempenho Individual',
    descricao: 'Análise detalhada da evolução de peso e GMD por animal.',
    icon: '⚖️',
    href: '/dashboard/relatorios/pesagens-desempenho',
    categoria: 'Produção',
    status: 'disponivel',
  },
  {
